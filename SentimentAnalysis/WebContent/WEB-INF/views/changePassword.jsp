					...
					<div class="row">
						...
						<p>${msg}</p>
							<div class="comment-form" >
								...
								<form action="changePassword" method="post" commandName="updatePassword">
									
									<div class="form-group">
										<input type="password" class="form-control" id="oldPassword" name="oldPassword" placeholder="Old Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subject'">
									</div>
									<div class="form-group">
										<input type="password" class="form-control" id="newPassword" name="newPassword" placeholder="New Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subject'">
									</div>
									<div class="form-group">
										<input type="password" class="form-control" id="reNewPassword" name="reNewPassword" placeholder="Re-enter New Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subject'">
									</div>
